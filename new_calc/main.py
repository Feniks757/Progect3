...
class Main_win(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # self.pushButton_5.clicked.connect(self.calc_skim)
        # self.pushButton_6.clicked.connect(self.calc_fat_suh)
        # self.pushButton_7.clicked.connect(self.calc_l_to_kg)
        # self.pushButton_8.clicked.connect(self.calc_pred)
        # self.pushButton_9.clicked.connect(self.calc_double_fals)
        # self.pushButton_10.clicked.connect(self.calc_towar)
        # self.pushButton_11.clicked.connect(self.calc_sale_milk)
    ...
    def calc_milk(self):
        if self.milk_gk_inp.text() and self.fat_milk_inp.text() and self.fat_milk_et_inp.text() and self.fat_cream_inp.text():
            milk_gk = float(self.milk_gk_inp.text())
            fat_milk = float(self.fat_milk_inp.text())
            fat_skim = float(self.fat_milk_et_inp.text())
            fat_cream = float(self.fat_cream_inp.text())
            result = (milk_gk*(fat_milk - fat_skim))/(fat_cream- fat_skim)
            self.milk_kg_ans.setText(self.round_number(result))
        else:
    ...
    def calc_dry_matter(self):
        if self.obesity_inp.text() and self.density_inp.text():
            ...
            self.dry_matter_ans.setText(self.round_number(result))
        else:
            self.show_message_box()
    ...
    def calc_dry_rez(self):
        if self.obesity2_inp.text() and self.density2_inp.text():
            ...
            self.somo_ans.setText(self.round_number(result))
        else:
            self.show_message_box()
    ...
    def calc_water(self):
        if self.somo_milk_inp.text() and self.dr_matter_inp.text():
            ...
            self.water_in_milk_ans.setText(self.round_number(result))
        else:
            self.show_message_box()
    ...
    #         self.skim_in_milk_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    # def calc_fat_suh(self):
    #     if self.fat_milk__et_inp_2.text() and self.somo_inp.text():
    #         fat_et = float(self.fat_milk__et_inp_2.text())
    #         somo_et = float(self.somo_inp.text())
    #         result = (fat_et / somo_et * 100)
    #         self.fat_suh_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    ...
    #         self.double_f_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    # def calc_towar(self):
    ...
    #         self.tow_milk_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    ...
    #         self.l_to_kg_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    ...
    #         self.milk_sale_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
    #
    # def calc_pred(self):
    ...
    #         self.pred_score_ans.setText(self.round_number(result))
    #     else:
    #         self.show_message_box()
